...
(deftest input-to-grid-whitespace-included-test
  (testing "input->grid-keep-whitespace"
    (is (= [[\1 \space \2 \space \3] [\4 \space \5 \space \6]
            [\7 \space \8 \space \9] [\+ \space \* \space \*]]
...
(deftest process-math-ops-test
  (testing "process-math-ops"
    (let [process-math-ops (comp core/process-math-ops
                                 core/grid-rows-columns-switch
                                 core/input->grid)]
...
(deftest process-math-ops-right-to-left-test
  (testing "process-math-ops-right-to-left"
    (let [process-math-ops (comp core/process-math-ops-right->left
                                 core/grid-rows-columns-switch
                                 core/input->grid-keep-whitespace)]
